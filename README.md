...
**เริ่มตรงไหนดี** — ถ้าเพิ่งเริ่มจากศูนย์ เปิด [`docs/SAR101.md`](docs/SAR101.md) ก่อน
แล้วรัน `01_point_target/point3_bp_2d.m` ซึ่งไฟล์เดียวมีครบทั้ง 5 ขั้นและเซฟรูปให้อัตโนมัติ
ส่วนใครที่จะแตะข้อมูลจริงเลย เริ่มที่ `04_gotcha_real/main/gotcha_bp_minimal.m` ยาวแค่ ~50 บรรทัด
...
> **MIT License ของ repo นี้ครอบคลุมเฉพาะโค้ดและเอกสารเท่านั้น ไม่ครอบคลุมข้อมูล GOTCHA**
> ชุดข้อมูลเป็นทรัพย์สินของ AFRL และมีเงื่อนไขการใช้งานของตัวเอง
...
<img src="docs/img/02_corner_localization.png" width="360" alt="corner reflector localization">
...
<img src="docs/img/03_circular_sar_box.png" width="620" alt="circular SAR box">
...
<img src="docs/img/04a_sim_vs_real_irf.png" width="720" alt="sim vs real IRF">
...
<img src="docs/img/04b_camry_sparse3d.png" width="720" alt="Camry sparse 3D">
...
<img src="docs/img/04c_width_fit_vs_spec.png" width="700" alt="width fit vs spec">
